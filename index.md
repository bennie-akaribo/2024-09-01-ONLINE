...
humandate: "Sep 01, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2014-09-01        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Benedicta Akaribo", "Mary Jane"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jane Doe", "John Smith"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
